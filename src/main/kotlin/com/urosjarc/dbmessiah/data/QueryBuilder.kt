 ...
 *
 * @param IN The type of [value].
 * @property value The class where input values will be located.
 * @property mapper The [Mapper] object to help in serialization process.
 *
 * @throws MappingException if the [value] class is not registered in global inputs.
 */
public open class QueryBuilder<IN : Any>(
     ...
     * It is populated through the [value] function, which takes a [KProperty1] object representing a property of the input class,
    ...
    /**
     * Retrieve the serialized value of a [value] property and adds it as a [QueryValue] to the [queryValues].
     ...
     */
    public fun value(kp: KProperty1<IN, *>): String {
