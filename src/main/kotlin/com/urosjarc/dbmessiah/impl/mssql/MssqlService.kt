...
public open class MssqlService : Service {
     ...
     */
    public fun transaction(isolation: Isolation? = null, body: (tr: MssqlTransConn) -> Unit): Unit =
        this.conn.transaction(isolation = isolation) { body(MssqlTransConn(conn = it, ser = this.ser)) }
}
