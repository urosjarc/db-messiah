...
public open class OracleSerializer(
    ...
    override fun <T : Any> createTable(table: KClass<T>): Query {
        ...
        //PRIMARY KEY
        val default =
            if (T.primaryKey.autoInc) " GENERATED BY DEFAULT ON NULL AS IDENTITY"
            else if (T.primaryKey.autoUUID) " AS UUID GENERATED BY DEFAULT"
            else ""

        col.add("${escaped(T.primaryKey.name)} ${T.primaryKey.dbType}${default}")
