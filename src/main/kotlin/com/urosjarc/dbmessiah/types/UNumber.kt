...
object UNumber {
    val UByte = TypeSerializer(
        ...
        decoder = { rs, i, dInfo -> rs.getByte(i).toUByte() },
    ...
    val UShort = TypeSerializer(
        ...
        decoder = { rs, i, dInfo -> rs.getShort(i).toUShort() },
    ...
    val UInt = TypeSerializer(
        ...
        decoder = { rs, i, dInfo -> rs.getInt(i).toUInt() },
    ...
    val ULong = TypeSerializer(
        ...
        decoder = { rs, i, dInfo -> rs.getLong(i).toULong() },
