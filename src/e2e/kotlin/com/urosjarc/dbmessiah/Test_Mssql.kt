...
open class Test_Mssql {
    ...
    fun prepare() {
        ...
        service.query {
            ...
            try { it.drop(Child::class) } catch (e: Throwable) { }
            try { it.drop(Parent::class) } catch (e: Throwable) { }
            try {it.create(Parent::class) } catch (e: Throwable) { }
            try {it.create(Child::class) } catch (e: Throwable) { }
        }
    ...
    private fun assertTableNotExists(q: MssqlQueryConn, kclass: KClass<*>) {
