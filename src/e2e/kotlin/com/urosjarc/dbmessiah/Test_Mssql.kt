...
open class Test_Mssql : Test_Contract {
    ...
    private fun assertTableNotExists(q: MssqlService.MssqlQueryConn, kclass: KClass<*>) {
    ...
    override fun `test rows deleteBatch`() = service.query {
        ...
        //Delete
        assertEquals(expected = 2, actual = it.batch.deleteBatch(rows = listOf(children[0], children[1])))
