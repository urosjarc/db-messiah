...
class Test_ProcedureArg {
    ...
    fun `test queryValue()`() {
        ...
        assertContains(
            ...
            " Trying to get value 'val com.urosjarc.dbmessiah.data.Test_ProcedureArg.TestProcedure.arg1: kotlin.String' but failed! " +
    ...
    fun `test setValue()`() {
        ...
        assertContains(
            ...
            "Trying to set property 'val com.urosjarc.dbmessiah.data.Test_ProcedureArg.TestProcedure.arg1: kotlin.String' " +
    ...
    fun `test getValue()`() {
        ...
        assertContains(
            charSequence = e1.message.toString(),
            "Trying to get value 'val com.urosjarc.dbmessiah.data.Test_ProcedureArg.TestProcedure.arg1: kotlin.String' but failed! Probably because receiving object is missing matching property or property does not belong to the receiver: TestProcedure2(arg0=0, arg1=arg1_value)",
            message = e1.toString()
        )
    }
}
