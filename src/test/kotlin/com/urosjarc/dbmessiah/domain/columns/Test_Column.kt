...
class Test_Column {
    ...
    fun `test setValue()`() {
        ...
        assertContains(
            ...
            other = "Trying to set property 'val com.urosjarc.dbmessiah.domain.columns.Test_Column.Entity.property: kotlin.String' to 'XXX' but the property is probably immutable"
        )
        ...
        assertContains(
            ...
            other = "Trying to set property 'var com.urosjarc.dbmessiah.domain.columns.Test_Column.Entity.id: kotlin.Int' to 'XXX' but failed! Probably because incompatible types or receiving object is missing matching property or property does not belong to the receiver: Entity(id=1, property=property1)"
        )
        ...
        assertContains(
            ...
            other = "Trying to set property 'var com.urosjarc.dbmessiah.domain.columns.Test_Column.Entity.id: kotlin.Int' to 'XXX' but failed! Probably because incompatible types or receiving object is missing matching property or property does not belong to the receiver: Entity2(text=text1)"
        )
